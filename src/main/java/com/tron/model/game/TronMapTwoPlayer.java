...
public class TronMapTwoPlayer extends TronMap {
	...
	public void paintComponent(Graphics g) {
	   ...
	   if (p1) {
		   try {
			   BufferedImage picture = ImageIO.read(new File("src/main/resources/p1_wins.png"));
			   if (picture == null) {
				   picture = ImageIO.read(new File("p1_wins.png"));
			   }
			   if (picture != null) {
				   g.drawImage
	   ...
	   if (p2) {
		   try{
			   BufferedImage picture = ImageIO.read(new File("src/main/resources/p2_wins.png"));
			   if (picture == null) {
				   picture = ImageIO.read(new File("p2_wins.png"));
			   }
			   if (picture != null) {
				   g.drawImage
				   		(picture, MAPWIDTH / 2 - 180, MAPHEIGHT / 2 - 30, null);
	   ...
	   if (tie) {
		   try {
			   BufferedImage picture = ImageIO.read(new File("src/main/resources/tie.png"));
			   if (picture == null) {
				   picture = ImageIO.read(new File("tie.png"));
			   }
			   if (picture != null) {
				   g.drawImage
